...
void printValues() {
    ...
    // change text color and font size when voltage is growing
    int mapValue = map(sensorValue1, 0, 1023, 0, 255);
    String hexValue = String(mapValue,HEX);
    int fontSize = map(sensorValue1, 0, 1023, 100, 150);
    ...
    String json1 = "\"sensor1\": " + String(volts1,3) + ",\"fontsize1\": " + fontSize + ",\"type1\": " + "\"volts\"" + ",\"color1\": " + "\"" + hexValue + "0000\"";
